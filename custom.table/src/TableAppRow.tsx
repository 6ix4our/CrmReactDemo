...
import { MapTableRowStateToProps, MapTableRowDispatchToProps } from './AppPropMappers';
...
export default connect(MapTableRowStateToProps, MapTableRowDispatchToProps)(TableAppRow) as 
